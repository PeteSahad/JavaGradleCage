...
public class MFCC {
	...
	private final static int       n_mfcc       		= 26;//20;
	private final static double    fMin                 = 0.0;//0.0;
	private final static int       n_fft                = 2048;
	private final static int       hop_length           = 2048;//512;//512;
	private final static int	   n_mels               = 128;//128;

	private final static double    sampleRate           = 48000;//16000.0;
	private final static double    fMax                 = sampleRate;//sampleRate/2.0;
